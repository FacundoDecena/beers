...
func (_ tBeers) List() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("Beers.List", args).URL
}
...
func (_ tBeers) Show(
	...
	revel.Unbind(args, "beerID", beerID)
	return revel.MainRouter.Reverse("Beers.Show", args).URL
}
